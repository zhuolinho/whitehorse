export PJDIR := /Users/hojolin/Desktop/pjproject-2.4.5
...
export CC_NAME := gcc
export TARGET_NAME := armv7-apple-darwin_ios
export CROSS_COMPILE := armv7-apple-darwin_ios-
...
# OPENH264 flags
OPENH264_CFLAGS = -DPJMEDIA_HAS_OPENH264_CODEC=1 -I/Users/hojolin/Documents/whitehorse//include 
OPENH264_LDFLAGS =  -L/Users/hojolin/Documents/whitehorse//lib -lopenh264 -lstdc++
...
# libyuv
LIBYUV_CFLAGS = -DPJMEDIA_HAS_LIBYUV=1 -I/Users/hojolin/Documents/whitehorse/libyuv//include 
LIBYUV_LDFLAGS =  -L/Users/hojolin/Documents/whitehorse/libyuv//out_ios/Release-iphoneos -lyuv_neon -lyuv
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	$(PJ_VIDEO_LDFLAGS) \
	-L/Users/hojolin/Documents/whitehorse/libyuv//out_ios/Release-iphoneos -L/Users/hojolin/Documents/whitehorse//lib -O2 -arch armv7 -isysroot /Applications/XCode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS9.1.sdk -framework AudioToolbox -framework Foundation
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
	...
	$(APP_THIRD_PARTY_EXT)\
	$(PJLIB_LDLIB) \
	-lyuv_neon -lyuv -lopenh264 -lstdc++ -lm -lpthread  -framework CoreAudio -framework CoreFoundation -framework AudioToolbox -framework CFNetwork -framework UIKit -framework UIKit -framework OpenGLES -framework AVFoundation -framework CoreGraphics -framework QuartzCore -framework CoreVideo -framework CoreMedia
...
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1	-I/Users/hojolin/Documents/whitehorse/libyuv//include -I/Users/hojolin/Documents/whitehorse//include -O2 -Wno-unused-label -DPJ_SDK_NAME="\"iPhoneOS9.1.sdk\"" -arch armv7 -isysroot /Applications/XCode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS9.1.sdk -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
